...
return [
    'title' => 'Superior Room',
    'description' => '  <p>No. of rooms : 34</p>
    <p>Area: 28 m<sup>2</sup></p>
    <p>Description:
            <span>cityview with balcony, Bathroom with shower</span>
</p>
    <p>Type bed: Double / Twin</p>',
    'content' => '<p>At POSEIDON NHA TRANG HOTEL, there are 34 Superior Cityview .</p>
