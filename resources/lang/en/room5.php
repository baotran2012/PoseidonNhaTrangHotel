...
return [
    ...
    'description' => '  <p>No. of rooms : 52</p>
    <p>Area: 30 m<sup>2</sup></p>
    <p>Description:
            <span>city view, Bathroom with shower</span>
</p>
    <p>Type bed: Double / Twin</p>',
    'content' => '<p>At POSEIDON NHA TRANG HOTEL, there are 52 Premier Cityview.</p>
