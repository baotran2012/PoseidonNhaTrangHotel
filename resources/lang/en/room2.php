...
return [
    ...
    'description' => '<p>No. of rooms : 7</p>
    <p>Area: 35 m<sup>2</sup></p>
    <p>Description:
            <span> city view with balcony, Bathroom with shower</span>
</p>
    <p>Type bed: Double / Twin</p>',
    'content' => '<p>At POSEIDON NHA TRANG HOTEL, there are 7 Family Executive City View.</p>
