    ...
    <div class="container h-container-mt">
        <div class="row gallery-view">
                <div class="gallerySlider flexslider">
                    <ul class="slides">
                            <li>
                                <img src="../Upload/files/nh3.jpg" class="img-responsive" />
                            </li>
                            <li>
                                <img src="../Upload/files/8_View04.jpg" class="img-responsive" />
                            </li>
                            <li>
                                <img src="../Upload/files/8_View03.jpg" class="img-responsive" />
                            </li>
                    </ul>
                </div>
