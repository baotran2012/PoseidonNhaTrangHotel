...
<!-- Mirrored from poseidonnhatranghotel.com/poseidon-promotion/honeymoon by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:33:29 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('family2.pagetitle') }} | Poseidon Nha Trang hotel</title>
            ...
            <div class="container contents">
                ...
                <div class="row">
                        <div class="room-title col-sm-12 mb20">
                            <h3>{!!html_entity_decode(__('family2.title'))!!}</h3>
                        </div>
                        <div class="col-sm-4">
                            <ul id="image-gallery" class="gallery list-unstyled lightSlider lsGrab lSSlide" style="width: 780px; transform: translate3d(-260px, 0px, 0px); height: 173px; padding-bottom: 0%;"><li data-thumb="/Upload/files/honeymoon1.jpg" class="clone left" style="width: 260px; margin-right: 0px;">
                                <img src="/Upload/files/honeymoon1.jpg" class="img-responsive mCS_img_loaded">
                            </li>
                            <li data-thumb="/Upload/files/honeymoon1.jpg" class="lslide active" style="width: 260px; margin-right: 0px;">
                                <img src="/Upload/files/honeymoon1.jpg" class="img-responsive mCS_img_loaded">
                            </li>

                    <li data-thumb="/Upload/files/honeymoon1.jpg" class="clone right" style="width: 260px; margin-right: 0px;">
                                <img src="/Upload/files/honeymoon1.jpg" class="img-responsive mCS_img_loaded">
                            </li></ul>
