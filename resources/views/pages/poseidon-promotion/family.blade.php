...
<head>
    ...
    <title>{{ __('family1.pagetitle') }} | Poseidon Nha Trang hotel</title>
            ...
            <div class="container contents">
                ...
                <div class="row">
                        <div class="room-title col-sm-12 mb20">
                            <h3>{!!html_entity_decode(__('family1.title'))!!}</h3>
                        </div>
                        <div class="col-sm-4">
                            <ul id="image-gallery" class="gallery list-unstyled lightSlider lSSlide lsGrab" style="width: 792px; transform: translate3d(-264px, 0px, 0px); height: 176px; padding-bottom: 0%;"><li data-thumb="/Upload/files/family-at-the-beach.jpg" class="clone left" style="width: 264px; margin-right: 0px;">
                                <img src="/Upload/files/family-at-the-beach.jpg" class="img-responsive mCS_img_loaded">
                            </li>
                            <li data-thumb="/Upload/files/family-at-the-beach.jpg" class="lslide active" style="width: 264px; margin-right: 0px;">
                                <img src="/Upload/files/family-at-the-beach.jpg" class="img-responsive mCS_img_loaded">
                            </li>

                    <li data-thumb="/Upload/files/family-at-the-beach.jpg" class="clone right" style="width: 264px; margin-right: 0px;">
                                <img src="/Upload/files/family-at-the-beach.jpg" class="img-responsive mCS_img_loaded">
                            </li></ul>
                        </div>
