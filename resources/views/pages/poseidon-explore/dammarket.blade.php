...
<!-- Mirrored from poseidonnhatranghotel.com/poseidon-explore/dammarket by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:33:29 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('explore2.pagetitle') }} | Poseidon Nha Trang hotel</title>
            ...
            <div class="container contents">
                ...
                <div class="row">
                    <div class="room-title col-sm-12 mb20">
                        <h3>{!!html_entity_decode(__('explore2.title'))!!}</h3>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-8 meeting-content">
                        {!!html_entity_decode(__('explore2.content'))!!}
                    </div>
