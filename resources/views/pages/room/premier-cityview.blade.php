...
<!-- Mirrored from poseidonnhatranghotel.com/room/premier-cityview by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:30:38 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('room5.title') }} | Poseidon Nha Trang hotel</title>
    <meta name="description" content="PREMIER CITYVIEW " />
    <meta name="keywords" content="PREMIER CITYVIEW ,poseidon, nha trang, vietnam, hotel,resort" />
                        ...
                        <div class="room-title col-sm-12 mb20">
                            ...
                            <div class="col-sm-5 mb20">
                                <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                        ...
                                        <li data-thumb="../Upload/_thumbs/images/Background/5.jpg">
                                            <img src="../Upload/images/Background/5.jpg" class="img-responsive">
                                        </li>
                                        <li data-thumb="../Upload/_thumbs/images/Background/kw_p%20dien%20hinh%20khach%20san%204-2.jpg">
                                            <img src="../Upload/images/Background/kw_p%20dien%20hinh%20khach%20san%204-2.jpg" class="img-responsive">
                                        </li>
                                </ul>
                            </div>

                        <div class="col-sm-7">
                            {!!html_entity_decode(__('room5.description'))!!}
                        </div>

                        <div class="clearfix mb20"></div>
                        <div class="col-sm-12 room-detail">
                            {!!html_entity_decode(__('room5.content'))!!}
                        </div>
                    </div>
