...
<head>
    ...
    <title>{{ __('room1.title') }} | Poseidon Nha Trang hotel</title>
    <meta name="description" content="DELUXE CITYVIEW WITH BALCONY " />
    <meta name="keywords" content="DELUXE CITYVIEW WITH BALCONY ,poseidon, nha trang, vietnam, hotel,resort" />
            ...
            <div class="container h-container-mt">
                ...
                <div class="container contents">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            {!!html_entity_decode(__('room1.description'))!!}

                        </div>

                        <div class="clearfix mb20"></div>
                        <div class="col-sm-12 room-detail">
                            {!!html_entity_decode(__('room1.content'))!!}
