...
<!-- Mirrored from poseidonnhatranghotel.com/room/luxury-Cityview by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:33:29 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('room3.title') }} | Poseidon Nha Trang hotel</title>
    <meta name="description" content="Luxury Cityview" />
    <meta name="keywords" content="Luxury Cityview,poseidon, nha trang, vietnam, hotel,resort" />
                ...
                <div class="container contents">
                    <div class="row">
                        <div class="room-title col-sm-12 mb20">
                            <h3>{{ __('room3.title') }}</h3>
                        </div>
                            <div class="col-sm-5 mb20">
                                <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                        <li data-thumb="../Upload/_thumbs/images/Background/1.jpg">
                                            <img src="../Upload/images/Background/1.jpg" class="img-responsive">
                                        </li>
                                        <li data-thumb="../Upload/_thumbs/images/Background/10.jpg">
                                            <img src="../Upload/images/Background/10.jpg" class="img-responsive">
                                        </li>
                                        <li data-thumb="../Upload/_thumbs/images/Background/11.jpg">
                                            <img src="../Upload/images/Background/11.jpg" class="img-responsive">
                                        </li>
                                </ul>
                            </div>

                        <div class="col-sm-7">
                            {!!html_entity_decode(__('room3.description'))!!}
                        </div>

                        <div class="clearfix mb20"></div>
                        <div class="col-sm-12 room-detail">
                            {!!html_entity_decode(__('room3.content'))!!}
