...
<!-- Mirrored from poseidonnhatranghotel.com/room/poseidon-suite by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 02:33:29 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('room4.title') }} | Poseidon Nha Trang hotel</title>
            ...
            <div class="container h-container-mt">
                ...
                <div class="container contents">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            {!!html_entity_decode(__('room4.description'))!!}
                        </div>

                        <div class="clearfix mb20"></div>
                        <div class="col-sm-12 room-detail">
                            {!!html_entity_decode(__('room4.content'))!!}
